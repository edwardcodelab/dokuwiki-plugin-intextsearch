...
function intextsearch(){
 if(document.getElementById('intextsearchid')==null){
         jQuery(document.createElement('div'))
               ...
               .html(
                    '<select id="itsearchengine"><option value="https://www.freecollocation.com/search?word=">freecollocation</option><option value="https://duckduckgo.com/?q=">duckduckgo</option><option value="https://en.wikipedia.org/wiki/">Wikipedia</option><br></select><iframe id="intextsearchurl" height="500px" width="100%" class="page group" overflow="wrap">'
                    )
               .parent()
